...
*** Picking A over C can be fine!

    Stats, aggregates, et cetera
...
*** All sorts of stuff can happen
    ...
    * E.g. SQL transactions
    ...
    #+BEGIN_NOTES
    Phantom reads: rows change
    Non-repeatable reads: data in a row changes
    #+END_NOTES
